...
# -----------------------------
def plot_forces(steps, Fmax, Frms, EDIFFG=None):
    ...
    plt.tight_layout()
    plt.savefig("fig_atomic-force-vs-step.png", dpi=200)
#    plt.show()  # 让 Spyder Plots 捕获显示
    print("fig_atomic-force-vs-step.png")

def plot_stresses(steps, stress_components):
#    labels = ["σ_xx", "σ_yy", "σ_zz", "σ_yz", "σ_xz", "σ_xy"]  # ASE 返回顺序
    ...
    plt.tight_layout()
    plt.savefig("fig_cell-stress-vs-step.png", dpi=200)
#    plt.show()  # 让 Spyder Plots 捕获显示
    print("Saved: fig_cell-stress-vs-step.png")

def plot_gforces(steps, stress_components, face_areas, EDIFFG=None):
    """
...
#    labels = ["G_xx", "G_yy", "G_zz", "G_yz", "G_xz", "G_xy"]
    ...
    plt.legend(ncol=2, fontsize=fs-2)
    plt.tight_layout()
    plt.savefig("fig_generalized-cell-force-vs-step.png", dpi=200)
#    plt.show()
    print("Saved: fig_generalized-cell-force-vs-step.png")
...
#    save_forces_and_stresses(forces_list, stress6)
    ...
    # 4) 分开绘图：两张图 + 广义力
    plot_forces(steps, Fmax, Frms, EDIFFG)
    plot_stresses(steps, stress6)
    plot_gforces(steps, stress6, face_areas, EDIFFG)  # ← 新增
