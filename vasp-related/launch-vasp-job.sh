...
items1=(XX YY ZZ)                     # Mandatory Argument, which is used to map structure name or job name
for i in ${items1[*]}
do
	items2=(XX2 YY2 ZZ2)                # Mandatory Argument, which is secondary for mapping structure name or job name 
	for j in ${items2[*]}
	do
